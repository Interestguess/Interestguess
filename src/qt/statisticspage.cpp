...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"lightgreen\">" + qVolume + " IGC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"lightred\">" + qVolume + " IGC" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"lightblue\">" + qVolume + " IGC" + "</font></b>");
    }
