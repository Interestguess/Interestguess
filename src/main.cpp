...
const string strMessageMagic = "InterestguessChain Signed Message:\n";
...
/* 	if (pindexBest->nHeight > (YEARLY_BLOCKCOUNT*37)) // 37 years.
	...
	if (pindexBest->nHeight <= 30000) // After 20 years, 0% PoS
        nRewardCoinYear = 0 * COIN_YEAR_REWARD; 
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "InterestguessChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "InterestguessChain";
        CTransaction txNew;
        txNew.nTime = 1541763753;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x384d8fad7f41757ff4b99e8b86536d1e39abd8bea417edeec13d0fcf8db1c09b"));
        block.print();
